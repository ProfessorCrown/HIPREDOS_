...
local repositoryURL = "https://raw.githubusercontent.com/ProfessorCrown/HIPREDOS_/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/INSTALLER HIPRED/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "HIPRED OS")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("HIPRED OS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("SYS HDD")
	end
	...
	EEPROMProxy.setLabel("HIPRED EFI")
